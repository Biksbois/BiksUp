...
def get_parameters():
    ...
    parameter_list.append(parameterObj(arg_name='--keys', arg_nargs='+', arg_default=['1'], arg_help="List of boolean keys of what permutation to execute, '1' = True, '0'=False, '-' = True and False. Example: ['1110-00']"))
